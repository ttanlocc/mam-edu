...
const COURSES = [
  {
    ...
    desc: 'GIAI ĐOẠN 1 · làm chủ L·R·S (L9 · R9 · S8.5) — 4h/ngày, KHÔNG học Writing năm nay (để năm sau ghép lấy overall 8.5). Speaking là trục chính đẩy 0→7→8→8.5; L·R cày lên 9.0 rồi giữ bằng full mock hằng tuần.',
...
const COURSE_DETAIL = {
  'ielts-85': {
    phases: [
      { n:1, nm:'LR Sprint',           r:'T1–3',  cur:true },
      { n:2, nm:'Khóa 9.0 · S lên 7',  r:'T4–6'  },
      { n:3, nm:'Speaking Sprint',     r:'T7–9'  },
      { n:4, nm:'Exam Readiness',      r:'T10–12'},
    ],
    sample_day: [
      { time:'07:00', dur:'70′', kind:'R', kindName:'READING',   title:'Full test / dạng câu hỏi timed + error log · giữ 9.0', seeds:18, c:'coral' },
      { time:'09:00', dur:'85′', kind:'S', kindName:'SPEAKING',  title:'Trục chính · iTalki + ELSA + Part 2/3 · đẩy tới 8.5', seeds:22, c:'sky' },
      { time:'14:00', dur:'70′', kind:'L', kindName:'LISTENING', title:'Chép chính tả CCT + NghĩaPhan full · cày/giữ 9.0', seeds:18, c:'sage' },
      { time:'19:00', dur:'20′', kind:'A', kindName:'ANKI',      title:'15 thẻ collocation production · nuôi Speaking', seeds:12, c:'mocha' },
      { time:'—',     dur:'—',   kind:'W', kindName:'WRITING',   title:'KHÔNG học năm nay — để năm sau (giai đoạn 2)', seeds:0, c:'butter' },
    ],
    week: [
      { d:'T2', label:'Reading full + Speaking' },
      { d:'T3', label:'iTalki tutor', special:true },
      { d:'T4', label:'Listening full + P3' },
      { d:'T5', label:'iTalki tutor', special:true },
      { d:'T6', label:'Pronunciation + mock prep' },
      { d:'T7', label:'Mock L + R + S', special:true },
      { d:'CN', label:'Nghỉ · deload', rest:true },
    ],
    features: [
      { gly:'✎', b:'Chỉ L·R·S năm nay', s:'Writing để năm sau (giai đoạn 2). 4h/ngày dồn cho Speaking (đẩy kịch trần 8.5) + L·R (full mock giữ 9.0).' },
      { gly:'◆', b:'4 gate cứng', s:'w13 mock L+R+S · w26 L/R 39–40/40 + S 7.0 · w39 iTk mock S 8.0 · w47 S 8.5 + L/R 9.0.' },
      { gly:'◦', b:'Anki deck collocation-first', s:'1.200+ thẻ production (không recognition) · SRS tự đẩy · nuôi Speaking Part 2/3.' },
      { gly:'○', b:'Pitfall watchlist', s:'7 failure modes — gồm spelling Listening, cẩu thả Reading, và maintenance-drift (tụt 9.0 nửa cuối).' },
    ],
  },
};
