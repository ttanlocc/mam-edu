...
const COURSES = [
  {
    ...
    desc: 'Lộ trình 12 tháng lên overall 8.5 (L9 · R9 · W7.0 · S8.0) — học TUẦN TỰ: 6 tháng đầu cày L·R lên 9.0 + Speaking lên 7.0, hoàn toàn KHÔNG Writing; 6 tháng cuối Writing 0→7.0 + Speaking 8.0, L/R duy trì.',
...
const COURSE_DETAIL = {
  'ielts-85': {
    phases: [
      ...
      { n:3, nm:'Writing Sprint',      r:'T7–9'  },
      { n:4, nm:'Exam Readiness',      r:'T10–12'},
    ],
    sample_day: [
      { time:'07:00', dur:'65′', kind:'R', kindName:'READING',   title:'Ngọc Bách dạng câu hỏi · 2–3 passage + error log', seeds:18, c:'coral' },
      { time:'09:00', dur:'65′', kind:'S', kindName:'SPEAKING',  title:'Script Part 2 + ghi âm + ELSA (iTalki 1–2×/tuần)', seeds:20, c:'sky' },
      { time:'14:00', dur:'70′', kind:'L', kindName:'LISTENING', title:'Chép chính tả CCT + BBC/72-track · cày 9.0', seeds:18, c:'sage' },
      { time:'19:00', dur:'25′', kind:'A', kindName:'ANKI',      title:'15 thẻ collocation production + review', seeds:12, c:'mocha' },
      { time:'—',     dur:'0′',  kind:'W', kindName:'WRITING',   title:'KHÔNG học 6 tháng đầu — mở ở Tháng 7 (100′/ngày)', seeds:0, c:'butter' },
    ],
    week: [
      { d:'T2', label:'GAP FILL + dictation' },
      { d:'T3', label:'MCQ + script #2' },
      { d:'T4', label:'TFNG + BBC shadow' },
      { d:'T5', label:'iTalki tutor', special:true },
      { d:'T6', label:'Headings + 72-track' },
      { d:'T7', label:'Mock L + R timed', special:true },
      { d:'CN', label:'Nghỉ · deload', rest:true },
    ],
    features: [
      { gly:'✎', b:'Tuần tự, không song song', s:'6 tháng đầu KHÔNG Writing — dồn 4h/ngày cày L·R 9.0 + Speaking 7.0; Writing nén 6 tháng cuối với chấm bài dày.' },
      { gly:'◆', b:'4 gate cứng', s:'w13 mock L+R+S · w26 L/R 39–40/40 + S 7.0 · w39 full mock đầu + W 6.5 · w47 W 7.0 + S 8.0.' },
      { gly:'◦', b:'Anki deck collocation-first', s:'1.200+ thẻ production (không recognition) · SRS tự đẩy.' },
      { gly:'○', b:'Pitfall watchlist zero-slack', s:'8 failure modes — gồm spelling Listening, cẩu thả Reading và cram-risk Writing 6 tháng cuối.' },
    ],
  },
};
